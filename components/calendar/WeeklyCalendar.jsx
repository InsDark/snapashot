...
const WeeklyCalendar = () => {
    ...
    return (
        ...
        >
            ...
            <WeekCalendar style={{  alignItems: 'center', justifyContent: 'center' }} theme={{ calendarBackground: COLORS.darkBlue, dayTextColor: COLORS.gray, selectedDayTextColor: COLORS.white, todayBackgroundColor: COLORS.lightBlue, selectedDayBackgroundColor: COLORS.gray }}
                onDayPress={(day) => {
